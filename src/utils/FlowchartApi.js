...
import { request } from './Api.js'; // eslint-disable-line no-shadow
...
export const getFlowchart = (flowchartId) =>
  request(HttpMethods.GET, `${baseUrl}/${flowchartId}`, null);

export const updateFlowchart = (flowchartId, updateContent) =>
  request(HttpMethods.PUT, `${baseUrl}/${flowchartId}`, updateContent);

export const deleteFlowchart = (flowchartId) =>
  request(HttpMethods.DELETE, `${baseUrl}/${flowchartId}`);

export const createFlowchart = (request) =>
  request(HttpMethods.POST, baseUrl, request);
